...
public class LeavesWordsController {
   ...
   private LeaveWordsService leaveWordsService;
    ...
    @ResponseBody
    public Result<LeaveWords> leavewordsById(long id) {
        LeaveWords leaveWords = leaveWordsService.selectLeavewordsByID(id);
        return new Result<>(1,"123",leaveWords);
    }*/
/*    @ResponseBody
    @RequestMapping(value = "/list",method = RequestMethod.GET)
    public Result leaveWordsResult(byte stat,String name) {
        if (name != null&&!name.equals("")) {
            ...
            return new Result(-1,"production name empty");
        }
